...
- Relaxed the tolerance to allow for cross-platforms minor differences
  in optimization. (0.11.4.1)

- Added [`on.exit()`](https://rdrr.io/r/base/on.exit.html) to functions
  that may create a cluster of R sessions. (0.11.4.2)
