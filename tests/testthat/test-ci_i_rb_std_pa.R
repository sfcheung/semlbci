...
test_that("Check with known results", {
    expect_equal(unname(out1x$bounds[1]), c(0.1133241), tolerance = 1e-4)
    expect_equal(unname(out2x$bounds[2]), c(0.559293), tolerance = 1e-4)
  })
