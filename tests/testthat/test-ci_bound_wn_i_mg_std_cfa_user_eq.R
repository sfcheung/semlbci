...
time1l <- system.time(out1l <- ci_bound_wn_i(47, 38, sem_out = fit, f_constr = fn_constr0, which = "lbound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time1u <- system.time(out1u <- ci_bound_wn_i(47, 38, sem_out = fit, f_constr = fn_constr0, which = "ubound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time2l <- system.time(out2l <- ci_bound_wn_i(15, 38, sem_out = fit, f_constr = fn_constr0, which = "lbound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time2u <- system.time(out2u <- ci_bound_wn_i(15, 38, sem_out = fit, f_constr = fn_constr0, which = "ubound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time3l <- system.time(out3l <- ci_bound_wn_i(26, 38, sem_out = fit, f_constr = fn_constr0, which = "lbound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time3u <- system.time(out3u <- ci_bound_wn_i(26, 38, sem_out = fit, f_constr = fn_constr0, which = "ubound", verbose = TRUE, ciperc = ciperc, standardized = TRUE))
