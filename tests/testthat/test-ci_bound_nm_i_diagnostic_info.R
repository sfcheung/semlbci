...
# context("Check ci_bound_nm_i: No equality constraints, test_generic = TRUE")
...
system.time(out1l <- ci_bound_nm_i(1, 5, sem_out = fit_med, which = "lbound", opts = opts0, test_generic = TRUE, verbose = TRUE))
system.time(out1u <- ci_bound_nm_i(1, 5, sem_out = fit_med, which = "ubound", opts = opts0, test_generic = TRUE, verbose = TRUE))
system.time(out1ls <- ci_bound_nm_i(2, 5, sem_out = fit_med, which = "lbound", opts = opts0, test_generic = TRUE, standardized = TRUE, verbose = TRUE))
system.time(out1us <- ci_bound_nm_i(2, 5, sem_out = fit_med, which = "ubound", opts = opts0, test_generic = TRUE, standardized = TRUE, verbose = TRUE))
