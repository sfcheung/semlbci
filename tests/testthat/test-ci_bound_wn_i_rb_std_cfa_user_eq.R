...
test_that("Check against precomputed answers", {
    ...
    # lavaan 0.6-21:     0.5286263
    # lavaan pre 0.6-21: 0.5286418
    # lavaan 0.6-21:     0.6195479
    # lavaan pre 0.6-21: 0.6195412
    expect_equal(out1l$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out3u$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out1l$bound, 0.5286418, tolerance = 1e-3)
    expect_equal(out3u$bound, 0.6195412, tolerance = 1e-3)
  })
