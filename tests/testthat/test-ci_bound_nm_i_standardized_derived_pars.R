...
system.time(out1ul <- ci_bound_nm_i(6, 5, sem_out = fit_med, which = "lbound", standardized = FALSE, opts = opts0))
system.time(out1uu <- ci_bound_nm_i(6, 5, sem_out = fit_med, which = "ubound", standardized = FALSE, opts = opts0))
