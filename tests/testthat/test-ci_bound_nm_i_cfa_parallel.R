...
system.time(out <- semlbci(fit_cfa, c(2, 3, 5, 6), opts = opts0, parallel = TRUE, ncpu = 4))
system.time({
      out2l <- ci_bound_nm_i(2, sem_out = fit_cfa, which = "lbound", opts = opts0)
      out2u <- ci_bound_nm_i(2, sem_out = fit_cfa, which = "ubound", opts = opts0)
      out3l <- ci_bound_nm_i(3, sem_out = fit_cfa, which = "lbound", opts = opts0)
      out3u <- ci_bound_nm_i(3, sem_out = fit_cfa, which = "ubound", opts = opts0)
      out5l <- ci_bound_nm_i(5, sem_out = fit_cfa, which = "lbound", opts = opts0)
      out5u <- ci_bound_nm_i(5, sem_out = fit_cfa, which = "ubound", opts = opts0)
      out6l <- ci_bound_nm_i(6, sem_out = fit_cfa, which = "lbound", opts = opts0)
      out6u <- ci_bound_nm_i(6, sem_out = fit_cfa, which = "ubound", opts = opts0)
      })
system.time(out <- semlbci(fit_cfa, c(2, 3, 5:15), opts = opts0, parallel = TRUE, ncpu = 6))
system.time(out <- semlbci(fit_cfa, c(2, 3, 5:15), opts = opts0))
