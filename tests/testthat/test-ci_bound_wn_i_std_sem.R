...
time1u <- system.time(out1u <- ci_bound_wn_i(2, 13, sem_out = fit, which = "lbound", opts = opts0, f_constr = fn_constr0, verbose = TRUE, ciperc = ciperc, standardized = TRUE, wald_ci_start = FALSE, std_method = "internal"))
...
save(fitc_out1l, fitc_out1u,
     ...
     file = "inst/testdata/test-ci_bound_wn_i_std_sem.RData",
     compress = "xz",
     compression_level = 9)
}

load(system.file("testdata", "test-ci_bound_wn_i_std_sem.RData",
                  package = "semlbci"))
