...
test_that("Check against precomputed answers", {
    ...
    # lavaan 0.6-21:     -0.02817138
    # lavaan pre 0.6-21: -0.02817139
    # lavaan 0.6-21:     0.2426529
    # lavaan pre 0.6-21: 0.2420445
    expect_equal(out1l$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out2u$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out1l$bound, -0.02817139, tolerance = 1e-2)
    expect_equal(out2u$bound, 0.2420445, tolerance = 1e-2)
  })
