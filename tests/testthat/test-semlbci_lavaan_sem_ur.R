...
fit_lbci_parallel <- semlbci(fit, pars = i_free[9:11], parallel = TRUE, ncpus = 3, method = "ur")
fit_lbci_no_parallel <- semlbci(fit, pars = i_free[9:11], parallel = FALSE, ncpus = 3, method = "ur")
