...
test_that("Check against precomputed answers", {
    ...
    # lavaan 0.6-21:     0.717682
    # lavaan pre 0.6-21: 0.7179538
    # lavaan 0.6-21:     1.631982
    # lavaan pre 0.6-21: 1.630801
    expect_equal(out1l$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out2u$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out1l$bound, 0.7179538, tolerance = 1e-3)
    expect_equal(out2u$bound, 1.630801, tolerance = 1e-3)
  })
