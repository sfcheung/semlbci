...
test_out2l <- test_constr(fit = fit, dat = simple_med, ciperc = ciperc, parc = "ab == ", modc0 = modc0, ci_out = out2l, semfct = lavaan::sem, tol = 1e-4, fixed.x = FALSE)
test_out2u <- test_constr(fit = fit, dat = simple_med, ciperc = ciperc, parc = "ab == ", modc0 = modc0, ci_out = out2u, semfct = lavaan::sem, tol = 1e-4, fixed.x = FALSE)
