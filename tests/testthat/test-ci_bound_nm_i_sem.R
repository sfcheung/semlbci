...
ci_cfa_lavaan <- semlbci(fit, pars = c(2, 3, 5, 6, 10, 11), opts = opts0, standardized = TRUE)
system.time(out2l <- ci_bound_nm_i(2, sem_out = fit, which = "lbound", opts = opts0, standardized = TRUE))
system.time(out3l <- ci_bound_nm_i(3, sem_out = fit, which = "lbound", opts = opts0, standardized = TRUE))
system.time(out5l <- ci_bound_nm_i(5, sem_out = fit, which = "lbound", opts = opts0, standardized = TRUE))
system.time(out6l <- ci_bound_nm_i(6, sem_out = fit, which = "lbound", opts = opts0, standardized = TRUE))
