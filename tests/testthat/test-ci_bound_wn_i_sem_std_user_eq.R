...
time2l <- system.time(out2l <- ci_bound_wn_i( 6, 13, sem_out = fit, which = "ubound", opts = opts0, f_constr = fn_constr0, verbose = TRUE, ciperc = ciperc, standardized = TRUE))
time2u <- system.time(out2u <- ci_bound_wn_i( 6, 13, sem_out = fit, which = "ubound", opts = opts0, f_constr = fn_constr0, verbose = TRUE, ciperc = ciperc, standardized = TRUE))
