...
# time1u <- system.time(out1u <- ci_bound_wn_i( 2, 38, sem_out = fit, which = "ubound", opts = list(ftol_rel = 1e-6), f_constr = fn_constr0, verbose = TRUE, ciperc = ciperc, sf = sf1$c_r, sf2 = sf1$c_rb, standardized = TRUE, wald_ci_start = FALSE, std_method = "internal"))
