...
test_that("Check against precomputed answers", {
    ...
    # lavaan 0.6-21:     0.5541664
    # lavaan pre 0.6-21: 0.5540218
    # lavaan 0.6-21:     0.9538491
    # lavaan pre 0.6-21: 0.9542735
    expect_equal(out1l$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out1u$diag$ciperc_final, .96, tolerance = 1e-3)
    expect_equal(out1l$bound, 0.5540218, tolerance = 1e-3)
    expect_equal(out1u$bound, 0.9542735, tolerance = 1e-3)
  })
