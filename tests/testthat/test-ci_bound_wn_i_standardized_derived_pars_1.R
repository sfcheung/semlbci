...
system.time(out1l <- ci_bound_wn_i(6, 5, sem_out = fit_med, f_constr = fn_constr0, which = "lbound", standardized = TRUE, opts = opts0, verbose = TRUE))
system.time(out1u <- ci_bound_wn_i(6, 5, sem_out = fit_med, f_constr = fn_constr0, which = "ubound", standardized = TRUE, opts = opts0, verbose = TRUE))
...
geteststd <- gen_fct(fit = fit_med, i = 6)
