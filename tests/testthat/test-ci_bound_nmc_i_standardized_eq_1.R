...
system.time(out2l <- ci_bound_nmc_i(2, 5, sem_out = fit_med, which = "lbound", standardized = TRUE, opts = opts0))
system.time(out2u <- ci_bound_nmc_i(2, 5, sem_out = fit_med, which = "ubound", standardized = TRUE, opts = opts0))
