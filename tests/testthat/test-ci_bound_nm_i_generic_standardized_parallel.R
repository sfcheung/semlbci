...
system.time(out <- semlbci(fit_med, c(1, 2), standardized = TRUE, opts = opts0, parallel = TRUE, ncpu = 2))

# system.time({
#   out1l <- ci_bound_nm_i(1, 5, sem_out = fit_med, which = "lbound", standardized = TRUE, opts = opts0, test_generic = TRUE)
#   out1u <- ci_bound_nm_i(1, 5, sem_out = fit_med, which = "ubound", standardized = TRUE, opts = opts0, test_generic = TRUE)
#   out2l <- ci_bound_nm_i(2, 5, sem_out = fit_med, which = "lbound", standardized = TRUE, opts = opts0, test_generic = TRUE)
#   out2u <- ci_bound_nm_i(2, 5, sem_out = fit_med, which = "ubound", standardized = TRUE, opts = opts0, test_generic = TRUE)
#   })
...
ci_semlbci_old <- c(out1l, out2l, out1u, out2u)
ci_semlbci <- c(out[c(1, 2), "lbci_lb"], out[c(1, 2), "lbci_ub"])
