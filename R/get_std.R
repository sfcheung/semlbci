...
#'  `"internal"` if it is confirmed to work in all situations tested. Note that
#'  if the internal method failed, the [get_std()] will fall back to the
#'  lavaan method.
#'
#' @examples
#' data(simple_med)
...
get_std <- function(fit_str, i, std_method = "lavaan") {
    ...
    # This method will be used if the internal method failed.
