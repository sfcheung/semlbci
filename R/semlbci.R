...
#'
#' @return
#' A modified parameter table, generated by [lavaan::parameterEstimates()],
#'    with the LBCIs for selected parameters
#'
...
#'              If NULL, the default, then LBCIs for all free parameters will
#'              be searched.
