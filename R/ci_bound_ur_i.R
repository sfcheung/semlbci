# NOTE:
# - Copied from semlbci::ci_bound_wn_i()
# - Need to be edited later.

#' @title Likelihood-based Confidence Bound For One parameter (uniroot)
#'
...
#'  equation model fitted in [lavaan::lavaan()] using [uniroot()].
#'
#' @details
#'
#' ## Important Notice
...
#' parameter.
#'
#' For consistency in the interface, most of the arguments
#' in [ci_bound_wn_i()] are also included in this function,
#' even those not used internally.
#'
#' ## Algorithm
#'
#' This function, unlike [ci_bound_wn_i()], use a simple
#' root finding algorithm. Basically, it try fixing the
#' target parameters to different values until the
#' likelihood ratio test *p*-value is equal to the desired
#' value.
#'
#' This algorithm is known to be very inefficient, compared
#' to the one proposed by Wu and Neale (2012). It is included
#' as a backup algorithm for parameters which are difficult
#' for the method by Wu and Neale.
#'
#' ## Limitation(s)
#'
#' Like [ci_bound_wn_i()], this function does not an estimate
#' close to an attainable bound.
#'
...
#'  parameter table of a lavaan object, generated by
#'  [lavaan::parameterTable()].
#'
#' @param npar Ignored by this function. Included for having
#' a unified interface.
#'
#' @param sem_out The fit object. Currently supports
#'  [lavaan::lavaan-class] objects only.
#'
#' @param f_constr Ignored by this function. Included for having
#' a unified interface.
#'
...
#'
#' @param perturbation_factor Ignored by this function. Included for having
#' a unified interface.
#'
#' @param lb_var Ignored by this function. Included for having
#' a unified interface.
#'
#' @param wald_ci_start Ignored by this function. Included for having
#' a unified interface.
#'
#' @param standardized If `TRUE`, the LBCI is for the requested
#'  estimate in the standardized solution. Default is `FALSE`.
#'
#' @param opts Options to be passed to [stats::uniroot()].
#' Default is `list()`.
#'
...
#'
#' @param sf Ignored by this function. Included for having
#' a unified interface.
#'
#' @param sf2 Ignored by this function. Included for having
#' a unified interface.
#'
...
#'
#' @param bounds Ignored by this function. Included for having
#' a unified interface.
#'
#' @param xtol_rel_factor Ignored by this function. Included for having
#' a unified interface.
#'
#' @param ftol_rel_factor Ignored by this function. Included for having
#' a unified interface.
#'
#' @param lb_prop Ignored by this function. Included for having
#' a unified interface.
#'
#' @param lb_se_k Ignored by this function. Included for having
#' a unified interface.
#'
...
#' [ci_bound_ur_i()]. This function will
#' be exported later because it is a
...
#' be reported on screen. Default is
#' `FALSE`.
#'
