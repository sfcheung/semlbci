...
For detailed documentation of other argumetns, please refer to its help page, as well as the help page for `ci_bound_wn_i()` and `ci_i_one()`, the functions called by `semlbci()`.
